...
public class ServerUDP {
	...
	ServerUDP(int port, Function<String, String> requestHandler, Consumer<String> receiveHandler) {
		this.port = port;
			...
			public void run() {
				try {
					...
					while (true) {
						...
						String requestContent = request.apply(receiveContent);

						byte[] sendData = requestContent.getBytes();
