...
<body>
    <div class="container">
        ...
        %>
        <h1>Edit Student</h1>
        <a href="ViewListClass?classId=<%=classInfo.getId() %>" class="btn btn-back mb-3"><i class="fa-solid fa-backward"></i> Back</a>
        <div class="form-container">
            <form action="CRUDStudent?mode=<%= mode %>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" value="<%= updateStudent != null ? updateStudent.getName() : "" %>">
                </div>
                <div class="form-group">
                    <label for="birthday">Birthday:</label>
                    <input type="text" class="form-control" id="birthday" name="birthday" value="<%= updateStudent != null ? updateStudent.getBirthday().format(formatter) : "" %>">
                </div>
                <div class="form-group">
                    <label for="gender">Gender:</label>
                    <input type="text" class="form-control" id="gender" name="gender" value="<%= updateStudent != null ? updateStudent.getGender() : "" %>">
                </div>
                <div class="form-group">
                    <label for="tel">Telephone:</label>
                    <input type="text" class="form-control" id="tel" name="tel" value="<%= updateStudent != null ? updateStudent.getTel() : "" %>">
                </div>
                <div class="form-group">
                    <label for="email">Email:</label>
                    <input type="text" class="form-control" id="email" name="email" value="<%= updateStudent != null ? updateStudent.getEmail() : "" %>">
                </div>
                <div class="form-group">
                    <label for="yearOfStudent">Year student:</label>
                    <input type="text" class="form-control" id="yearOfStudent" name="yearOfStudent" value="<%= updateStudent != null ? updateStudent.getYearOfStudent() : "" %>">
                </div>
                <div class="form-group">
                    <label for="className">Class:</label>
                    <input type="text" class="form-control" readonly="readonly" id="className" name="className" value="<%= classInfo != null ? classInfo.getName() : "" %>">
                </div>
                <div class="form-group">
